        ...
        <MDBRow className="text-center text-md-left mt-3 pb-3">
          <MDBCol md="3" lg="3" xl="4" className="mx-auto mt-3">
            ...
            <p>
              ...
              purchase used books online. Through this book store the users can
          ...
          <MDBCol md="4" lg="3" xl="3" className="mx-auto mt-3">
            ...
            <p>
              <i className="fa fa-envelope mr-3" /> mb8@gmail.com
            </p>
            <p>
              <i className="fa fa-phone mr-3" /> +91 888888888
            </p>
            <p>
              <i className="fa fa-home mr-3" /> VNRVJIET
            </p>
          </MDBCol>
        </MDBRow>
        <hr />
